...
/* harmony import */ var _components__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! src/components */ "./src/components/index.ts");
/* harmony import */ var src_utils_useStorage__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! src/utils/useStorage */ "./src/utils/useStorage.ts");
/* harmony import */ var src_monaco__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! src/monaco */ "./src/monaco.ts");
/* harmony import */ var src_utils_useWindowEvent__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! src/utils/useWindowEvent */ "./src/utils/useWindowEvent.tsx");
/* harmony import */ var src_contexts_FileSystemContext__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! src/contexts/FileSystemContext */ "./src/contexts/FileSystemContext.tsx");
...
function App() {
    var _a;
    const windowWidth = (0,src_utils_useStorage__WEBPACK_IMPORTED_MODULE_5__.useStorage)(document.body.clientWidth);
    const panelWidth = (0,src_utils_useStorage__WEBPACK_IMPORTED_MODULE_5__.useStorage)(windowWidth.value * .15);
    const fileContext = (0,src_contexts_FileSystemContext__WEBPACK_IMPORTED_MODULE_8__.useFileSystemContext)();
    (0,src_utils_useWindowEvent__WEBPACK_IMPORTED_MODULE_7__.useWindowEvent)('resize', (e) => {
        windowWidth.set(document.body.clientWidth);
    });
    return ((0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(react__WEBPACK_IMPORTED_MODULE_1__.Fragment, { children: [(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components__WEBPACK_IMPORTED_MODULE_4__.Panel, { widthStorage: panelWidth }), (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components__WEBPACK_IMPORTED_MODULE_4__.ResizeBorder.Left, { maxValue: windowWidth.value * .8, storage: panelWidth }), (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("div", { className: "right", style: { width: `calc(100% - ${panelWidth.value}px)` }, children: [(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_monaco_editor_react__WEBPACK_IMPORTED_MODULE_3__["default"], { loading: "", theme: src_monaco__WEBPACK_IMPORTED_MODULE_6__.themeName, language: src_monaco__WEBPACK_IMPORTED_MODULE_6__.languageName, options: { contextmenu: false }, value: (_a = fileContext.contentCurrent()) !== null && _a !== void 0 ? _a : '', onChange: (v) => fileContext.inputCurrent(v !== null && v !== void 0 ? v : ''), beforeMount: src_monaco__WEBPACK_IMPORTED_MODULE_6__.edit, width: windowWidth.value - panelWidth.value }), (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)("div", { className: "terminal" })] })] }));
}
...
/* harmony export */ });
/* harmony import */ var react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! react/jsx-runtime */ "./node_modules/react/jsx-runtime.js");
/* harmony import */ var src_contexts_ContextMenuContext__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! src/contexts/ContextMenuContext */ "./src/contexts/ContextMenuContext.tsx");
/* harmony import */ var src_contexts_FileSystemContext__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! src/contexts/FileSystemContext */ "./src/contexts/FileSystemContext.tsx");
/* harmony import */ var _Explorer_styles_scss__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./Explorer.styles.scss */ "./src/components/Explorer/Explorer.styles.scss");
...
function Explorer() {
    const contextMenu = (0,src_contexts_ContextMenuContext__WEBPACK_IMPORTED_MODULE_1__.useContextMenuContext)();
    const fileContext = (0,src_contexts_FileSystemContext__WEBPACK_IMPORTED_MODULE_2__.useFileSystemContext)();
...
function ExplorerItem(props) {
    const tempName = (0,src_utils__WEBPACK_IMPORTED_MODULE_4__.useStorage)('');
    const contextMenu = (0,src_contexts_ContextMenuContext__WEBPACK_IMPORTED_MODULE_1__.useContextMenuContext)();
    const onContextMenu = (e) => {
        const options = [];
...
/* harmony import */ var _Panel_styles_scss__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./Panel.styles.scss */ "./src/components/Panel/Panel.styles.scss");



function Panel(props) {
    return ((0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("div", { className: "panel", style: { width: props.widthStorage.value + 'px' }, children: [(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(src_components__WEBPACK_IMPORTED_MODULE_1__.Explorer, {}), (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)("div", { className: "tasks" })] }));
}
...
/* harmony import */ var src_utils_components__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! src/utils/components */ "./src/utils/components/index.ts");
...
(function (ResizeBorder) {
    function Left(props) { return component("left", props.storage, props.maxValue); }
    ResizeBorder.Left = Left;
    function Top(props) { return component("top", props.storage, props.maxValue); }
    ResizeBorder.Top = Top;
    function Right(props) { return component("right", props.storage, props.maxValue); }
    ResizeBorder.Right = Right;
    function Bottom(props) { return component("bottom", props.storage, props.maxValue); }
    ResizeBorder.Bottom = Bottom;
    function component(anchor, storage, maxValue) {
        const hovered = (0,src_utils__WEBPACK_IMPORTED_MODULE_1__.useStorage)(false);
        const pressed = (0,src_utils__WEBPACK_IMPORTED_MODULE_1__.useStorage)(false);
        (0,src_utils__WEBPACK_IMPORTED_MODULE_1__.useDocumentEvent)('mousemove', (e) => {
            if (!pressed.value)
                return;
            const value = anchor == "left" || anchor == "right"
                ? e.pageX
                : e.pageY;
            storage.set((0,src_utils__WEBPACK_IMPORTED_MODULE_1__.clamp)(value, 0, maxValue));
        });
        (0,src_utils__WEBPACK_IMPORTED_MODULE_1__.useDocumentEvent)('mouseup', (e) => {
            if (!pressed.value)
                return;
            pressed.set(false);
        });
        return ((0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(src_utils_components__WEBPACK_IMPORTED_MODULE_2__.ClassName, { class: (hovered.value || pressed.value) && "resize-border__hovered", children: (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)("div", { className: `resize-border noselect resize-border__${anchor}`, style: { left: (storage.value - 3) + 'px' }, onMouseDown: () => pressed.set(true), onMouseEnter: () => hovered.set(true), onMouseLeave: () => hovered.set(false) }) }));
    }
...
function ContextMenuProvider(props) {
    const storage = (0,src_utils__WEBPACK_IMPORTED_MODULE_3__.useStorage)({ options: [] });
...
function FileSystemProvider(props) {
    const current = (0,src_utils__WEBPACK_IMPORTED_MODULE_2__.useStorage)(0);
    const files = (0,src_utils__WEBPACK_IMPORTED_MODULE_2__.useStorage)([
...
/* harmony import */ var src_utils_utils__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! src/utils/utils */ "./src/utils/utils.ts");


function ClassName(props) {
    var _a;
    const className = (0,src_utils_utils__WEBPACK_IMPORTED_MODULE_1__.toArrayIfNot)(props.class).filter(Boolean).join(' ');
    if ((0,react__WEBPACK_IMPORTED_MODULE_0__.isValidElement)(props.children)) {
        let currentClassName = (_a = props.children.props.className) !== null && _a !== void 0 ? _a : '';
        if (!currentClassName.endsWith(' '))
            currentClassName += ' ';
...
/* harmony export */   toArrayIfNot: () => (/* reexport safe */ _utils__WEBPACK_IMPORTED_MODULE_2__.toArrayIfNot),
...
/* harmony export */ });
/* harmony import */ var _useDocumentEvent__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./useDocumentEvent */ "./src/utils/useDocumentEvent.tsx");
/* harmony import */ var _useStorage__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./useStorage */ "./src/utils/useStorage.ts");
...
/***/ "./src/utils/useDocumentEvent.tsx":
/*!****************************************!*\
  !*** ./src/utils/useDocumentEvent.tsx ***!
  \****************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
//# sourceMappingURL=main.49818055.js.map